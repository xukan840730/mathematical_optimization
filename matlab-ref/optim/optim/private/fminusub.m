...
%   $Revision: 1.1.6.14 $  $Date: 2008/12/01 07:20:46 $
...
if ~gradflag || DerivativeCheck
    ...
    [gradFd,unused1,unused2,numEvals] = finitedifferences(x,funfcn{3},[],[],[],f, ...
        [],[],1:numberOfVariables,true,finDiffOpts,sizes,gradFd,[],[],[],[],varargin{:});
...
while ~done
    ...
    [alpha,f,grad,exitflagLnSrch,funcCountLnSrch] = ... 
            lineSearch(funfcn,x,numberOfVariables,dir, ...
            f,dirDerivative,alpha1,rho,sigma,fminimum,maxFunEvalsLnSrch, ...
            eps(max(1,abs(f))),finDiffOpts,sizes,grad,varargin{:});
