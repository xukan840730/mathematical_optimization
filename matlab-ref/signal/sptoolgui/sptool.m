...
switch action
    ...
    case 'open'
        ...
        switch nargin
            ...
            case 2
                ...
                loadName = which(f);
                if isempty(loadName)
                    error(generatemsgid('GUIErr'),['File ' f ' not found.'])
                end
                ud.sessionPath = '';
            case 3
                f = varargin{2};
                if isequal(varargin{3}, 1)
                    ...
                    if exist(loadName, 'file')~=2
                        error(generatemsgid('GUIErr'),['File ' loadName ' not found.'])
                    end
                end
        end
    ...
    case 'create'
        ...
        if isempty(formIndx)
            set(0,'showhiddenhandles',shh)
            error(generatemsgid('GUIErr'),['Sorry, the form must be one of the following: ',...
                formTags])
